  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-6">
        ...
        <h2 className="text-xl sm:text-2xl font-semibold">Confirm Your Appointment</h2>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 max-w-2xl">
        <Button variant="outline" onClick={onModify} className="w-full sm:w-auto">
          Modify Appointment
        </Button>
        <Button onClick={onConfirm} className="w-full sm:w-auto bg-primary" disabled={isBooking}>
