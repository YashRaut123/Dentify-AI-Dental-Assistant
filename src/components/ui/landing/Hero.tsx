...
function Hero() {
    ...
    return (
        <section className="relative min-h-screen lg:h-screen flex items-center overflow-hidden pt-20">
            {/* GRID BG  */}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
                        ...
                        <div className="space-y-8 md:space-y-10">
                            <div className="space-y-5 md:space-y-6">
                                ...
                                {/* SUBTITLE */}
                                <p className="text-sm sm:text-base md:text-lg text-muted-foreground leading-relaxed max-w-xl font-medium">
                            ...
                            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                                {mounted ? (
                                    ...
                                    <>
                                        <Button size={"lg"} aria-hidden="true" className="w-full sm:w-auto pointer-events-none opacity-0">
                                            <MicIcon className="mr-2 size-5" />
                                            Try voice agent
                                        </Button>
                                        <Button
                                            ...
                                            variant={"outline"}
                                            aria-hidden="true"
                                            className="w-full sm:w-auto pointer-events-none opacity-0"
                                        >
                                            <CalendarIcon className="mr-2 size-5" />
                                            Book appointment
                                        </Button>
                        ...
                        <div className="relative lg:pl-8 max-w-xl mx-auto w-full">
                            {/* GRADIENT ORBS */}
