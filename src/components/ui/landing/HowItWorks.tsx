      ...
      <div className="text-center mt-16">
        <SignedOutView>
          <SignUpButton mode="modal">
            <button className="bg-primary text-primary-foreground hover:bg-primary/90 focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 transition-all duration-300 py-3 px-6 rounded-full font-bold shadow-lg hover:shadow-primary/20">
              Get Started
            </button>
          </SignUpButton>
        </SignedOutView>
        ...
        <SignedInView>
          <Link
            href="/dashboard"
            className="inline-flex bg-primary text-primary-foreground hover:bg-primary/90 focus:ring-2 focus:ring-primary/50 focus:ring-offset-2 transition-all duration-300 py-3 px-6 rounded-full font-bold shadow-lg hover:shadow-primary/20"
          >
            Go to Dashboard
          </Link>
        </SignedInView>
