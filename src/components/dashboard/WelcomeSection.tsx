...
export default async function WelcomeSection() {
  ...
  return (
    <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 bg-linear-to-br from-primary/10 via-primary/5 to-background rounded-3xl p-5 sm:p-8 border border-primary/20 mb-12 overflow-hidden">
