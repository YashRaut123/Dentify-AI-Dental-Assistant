  ...
  const handleBookAppointment = async () => {
    ...
    bookAppointmentMutation.mutate(
      ...
      },
      {
        ...
        onError: (error: Error) => toast.error(`Failed to book appointment: ${error.message}`),
      }
    );
  };
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8 pt-24">
        {/* header */}
        <div className="mb-8">
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">Book an Appointment</h1>
          <p className="text-sm sm:text-base text-muted-foreground">Find and book with verified dentists in your area</p>
        </div>
      ...
      {userAppointments.length > 0 && (
        <div className="mb-8 max-w-7xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
